...
export default function User({auth, users, substations, roles}) {
    ...
    return (
        ...
        <Modal2 isOpen={openModal} onClose={() => setOpenModal(false)} title="New User">
        <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" disabled={processing} className="p-2 text-sm text-white rounded-md focus:ring-4 focus:ring-sky-300 bg-sky-600">
                            Add User
                        </button>
